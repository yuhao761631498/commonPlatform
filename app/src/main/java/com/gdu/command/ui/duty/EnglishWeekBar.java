...
public class EnglishWeekBar extends WeekBar {
    ...
    public EnglishWeekBar(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(com.gdu.command.R.layout.english_week_bar, this, true);
    ...
    private String getWeekString(int index, int weekStart) {
        String[] weeks = getContext().getResources().getStringArray(com.gdu.command.R.array.english_week_string_array);
