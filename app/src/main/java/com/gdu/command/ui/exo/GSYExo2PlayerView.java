package com.gdu.command.ui.exo;
...
import static com.gdu.command.ui.exo.GSYExo2MediaPlayer.POSITION_DISCONTINUITY;
...
public class GSYExo2PlayerView extends StandardGSYVideoPlayer {
     ...
     * @return
     */
    public boolean setUp(GSYVideoModel url) {
        final List<GSYVideoModel> urls = new ArrayList<>();
        urls.add(url);
        return setUp(urls, 0, null, new HashMap<String, String>());
    }
