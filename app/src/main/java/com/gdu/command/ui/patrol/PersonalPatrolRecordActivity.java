...
import com.gdu.command.databinding.ActivityPersonalPatrolRecordBinding;
 ...
 * create by zyf
 */
public class PersonalPatrolRecordActivity extends RefreshActivity<PatrolPresenter>
        implements View.OnClickListener, IPatrolDiaryView {
    ...
    private ActivityPersonalPatrolRecordBinding mBinding;
    ...
    protected void initialize() {
        ...
        mBinding = ActivityPersonalPatrolRecordBinding.inflate(LayoutInflater.from(this));
        initView();
        initListener();

        tvTitleName.setText("个人巡逻记录");
    }
    ...
    private void queryData(int sort) {
        MyLogUtils.d("queryData() sort = " + sort);
        sortType = sort;
        final int userId = MMKVUtil.getInt(SPStringUtils.USER_ID);
