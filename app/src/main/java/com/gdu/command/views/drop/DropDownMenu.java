...
public class DropDownMenu  extends LinearLayout {
    ...
    //tab选中颜色
    private int textSelectedColor = 0xFF5F5F61;
    //tab未选中颜色
    private int textUnselectedColor = 0xFF436BFF;
    //遮罩颜色
...
//        }
     ...
     * @param text
     */
    public void setChildText(int index, String text) {
        if (CommonUtils.isEmptyString(text) || tabMenuView.getChildAt(index) == null) {
            return;
        }
    ...
    private void switchMenu(View target) {
        MyLogUtils.d("switchMenu() current_tab_position = " + current_tab_position);
