...
import com.gdu.baselibrary.base.route.Injector;
...
public class BaseApplication extends Application {
    ...
    public void onCreate() {
        ...
        // MMKV
        final String rootDir = MMKV.initialize(this);
        Log.d("MMKV", "MMKV init rootPath = " + rootDir);
    }
