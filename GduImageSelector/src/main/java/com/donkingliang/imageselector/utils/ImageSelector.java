...
public class ImageSelector {
    ...
    public static class ImageSelectorBuilder {
        ...
        /**
         * 图片列表是否包含视频
         * @param isContainVideo
         * @return
         */
        public ImageSelectorBuilder setContainVideo(boolean isContainVideo){
            config.isContainVideo = isContainVideo;
            return this;
        }
         ...
         * @return
         */
        public ImageSelectorBuilder setContainPhoto(boolean isContainPhoto){
            config.isContainPhoto = isContainPhoto;
            return this;
        }
         ...
         * @return
         */
        public ImageSelectorBuilder setTakePhoto(boolean isTakePhoto){
            config.isTakePhoto = isTakePhoto;
            return this;
        }
         ...
         * @return
         */
        public ImageSelectorBuilder setTakeVideo(boolean isTakeVideo){
            config.isTakeVideo = isTakeVideo;
            return this;
        }
