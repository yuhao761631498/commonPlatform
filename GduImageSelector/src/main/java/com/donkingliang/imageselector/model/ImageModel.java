...
public class ImageModel {
    ...
    private static void preload(final Context context) {
        ...
        if (hasWriteExternalPermission == PackageManager.PERMISSION_GRANTED) {
            //有权限，加载图片。
            loadImageForSDCard(context, true, isContainVideo, null);
        }
    }
     ...
     * @param callback
     */
    public static void loadImageForSDCard(final Context context, boolean isContainVideo, boolean isContainPhoto, final DataCallback callback) {
        loadImageForSDCard(context, false, isContainVideo, isContainPhoto, callback);
    }
     ...
     * @param callback
     */
    public static void loadImageForSDCard(final Context context, boolean isContainVideo, final DataCallback callback) {
        loadImageForSDCard(context, false, isContainVideo, true, callback);
    }
     ...
     * @param callback
     */
    private static void loadImageForSDCard(final Context context, final boolean isPreload, boolean isContainVideo, boolean isContainPhoto, final DataCallback callback) {
            ...
            public void run() {
                synchronized (ImageModel.class) {
                    ...
                    if (cacheImageList == null || isPreload) {
                        ...
                        ArrayList<Image> allList = new ArrayList<>();
                        if (isContainPhoto) {
                        ...
                        Collections.sort(allList, new Comparator<Image>() {
                            @Override
